...
#     # Armar líneas de esquema con ejemplos (máx 3 por columna)
#     schema_lines = []
...
#   "table_fqn": "{fq_table}",
#   "table_description": {
#     "description": "Resumen claro del propósito y contenido de la tabla (entre un rango de 300 y 700 caracteres).",
#     "confidence": 0.0
#   },
#   "columns": [
#     {
#     "name": "nombre_de_columna",
#     "description": "Descripción de negocio de la columna (significado, uso, ejemplos comunes; entre un rango de 300 y 700 caracteres).",
#     "confidence": 0.0,
